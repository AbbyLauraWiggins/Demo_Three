...
public class DropDownListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(AnalyseStats.checkSelected[position])
    ...
    private void setText(int position1){
        if (!AnalyseStats.checkSelected[position1]) {
            AnalyseStats.checkSelected[position1] = true;
            selectedCount++;
        } else {
            AnalyseStats.checkSelected[position1] = false;
            selectedCount--;
        }
        ...
        if (selectedCount == 0) {
            ...
            for (int i = 0; i < AnalyseStats.checkSelected.length; i++) {
                if (AnalyseStats.checkSelected[i] == true) {
